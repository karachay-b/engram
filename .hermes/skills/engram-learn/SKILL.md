...
# Engram — die Erwerbsschleife (Hermes)

Neues Thema aufbauen oder fortsetzen: Kurrikulum, Tutoring, blinde Bewertung.
...
2. **`$ENGRAM_ROOT/.claude/skills/engram-learn/SKILL.md` vollständig lesen** und wörtlich
   befolgen — mit den Übersetzungen aus Schritt 1. Dort stehen die Regeln dieses
   Forks; sie sind nicht zusammenfassbar.
3. Jene Datei verlangt ihrerseits **`$ENGRAM_ROOT/skills/learn/SKILL.md` in voller
