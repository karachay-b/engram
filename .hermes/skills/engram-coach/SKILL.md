...
# Engram — Telemetrie und Strategie (Hermes)

Retention, Kalibrierung, Grader-Audit, n-of-1-Experimente, Tuning.
...
2. **`$ENGRAM_ROOT/.claude/skills/engram-coach/SKILL.md` vollständig lesen** und wörtlich
   befolgen — mit den Übersetzungen aus Schritt 1. Dort stehen die Regeln dieses
   Forks; sie sind nicht zusammenfassbar.
3. Jene Datei verlangt ihrerseits **`$ENGRAM_ROOT/skills/coach/SKILL.md` in voller
